...
<p align="center">
  <img src="pictures/06_create_new_cs.png" width="60%" height="30%" title="create_new_cs">
</p>

Now I’ll select the repository that I want to use for the Codespace:

<p align="center">
  <img src="pictures/07_create_new_cs_select_repo.png" width="60%" height="30%" title="create_new_cs_select_repo">
</p>

As the last step, I’ll choose which instance I would like to use. I’ll choose the 2 cores option:

<p align="center">
  <img src="pictures/07_create_new_cs_select_instance.png" width="60%" height="30%" title="07_create_new_cs_select_instance">
</p>
